...
生成时间: 2026-09-23 17:51:58
生成工具: API AI Test Framework - Stage 2
版本: v1.0.0

用法:
    python 资源池容量.py                    # 运行所有操作
    python 资源池容量.py create update      # 只运行 create 和 update
    python 资源池容量.py --headless         # 无头模式
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="资源池容量 UI 自动化测试脚本")
    ...
    async with async_playwright() as p:
        ...
        report_path = generate_html_report(results, "资源池容量")
        print(f"\n{'='*60}")
        print(f"  ✅ 测试完成")
        print(f"{'='*60}")
