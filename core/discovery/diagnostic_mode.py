...
- 输出诊断报告到 workspace/output/debug/{module}/diagnostic_{timestamp}/
"""
...
class DiagnosticMode:
    ...
    def __init__(self, page: Page, module_name: str, project_dir: Path,
        ...
        self.workspace_dir = get_workspace_dir(project_dir)
    ...
    async def run_strategy(self, strategy_name: str, **kwargs) -> Dict[str, Any]:
        ...
        self.debug_dir = self.workspace_dir / "output" / "debug" / self.module_name / f"diagnostic_{self.timestamp}"
