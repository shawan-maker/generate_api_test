...
def draco_list_projects(c, **extra):
    """list: /estack/api/estack/draco/v1/projects/list/available
    body_keys: ["productList"]
    """
    url = "/estack/api/estack/draco/v1/projects/list/available"
    return ApiResponse(c.request(
        "POST", url, json=extra or None))


def draco_list_projects(c, **extra):
    """list: /estack/api/estack/draco/inner/v1/projects/list
    body_keys: ["productList"]
    """
    url = "/estack/api/estack/draco/inner/v1/projects/list"
    return ApiResponse(c.request(
        "POST", url, json=extra or None))
